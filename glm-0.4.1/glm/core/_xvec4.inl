...
namespace glm
{
    ...
    template <typename T> 
    inline _xvec4<T>& _xvec4<T>::operator=(const glm::_xvec4<T>& x)
    {
        this->x = x.x;
        this->y = x.y;
        this->z = x.z;
    ...
    template <typename T> 
    inline _xvec4<T>& _xvec4<T>::operator+=(const glm::_xvec4<T> & v)
    {
	    this->x += v.x;
	    this->y += v.y;
        this->z += v.z;
