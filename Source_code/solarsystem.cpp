...
SolarSystem::SolarSystem() {
    ...
    _displayMode = SolarSystem::SMOOTHSHADED;
...
void SolarSystem::init_system() {
    ...
    cout << endl << "Additional features include:" << endl << "-Displaying axis with the 'i' key." << endl << "-Hiding orbit lines with the 'o' key." << endl << endl << "For more information please refer to the Read_Me.txt in the source folder." <<endl;
}


void SolarSystem::draw_system() {
    static float fSemiMajorAxis = 0.0f;
    ...
    switch (_displayMode) {
    case SolarSystem::WIREFRAME:
      glDisable(GL_LIGHTING);
      glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
      break;
    case SolarSystem::FLATSHADED:
      glEnable(GL_LIGHTING);
      glShadeModel(GL_FLAT);
      glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
      break;
    case SolarSystem::SMOOTHSHADED:
      glEnable(GL_LIGHTING);
...
void SolarSystem::nextDisplayMode()
{
  _displayMode = (_displayMode+1)%3;
  cout << "SetDisplayMode: "<< _displayMode%3 << endl;
...
void SolarSystem::toggle_texture(){
    ...
    cout << "Toggle textures: " << _textured << endl;
}
